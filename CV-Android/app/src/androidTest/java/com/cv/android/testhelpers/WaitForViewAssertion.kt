package com.cv.android.testhelpers
...
private constructor(
    ...
    override fun getConstraints() = ViewMatchers.withId(mViewId)

    override fun getDescription() =
        "$matcher on ${InstrumentationRegistry.getInstrumentation().context.resources.getResourceName(mViewId)}"
